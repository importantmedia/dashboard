...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Publisher.brand_safety_level'
        db.add_column(u'publishers', 'brand_safety_level', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Publisher.brand_safety_level'
        db.delete_column(u'publishers', 'brand_safety_level')
