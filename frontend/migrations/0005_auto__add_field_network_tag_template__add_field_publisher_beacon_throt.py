...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Network.tag_template'
        db.add_column(u'networks', 'tag_template', self.gf('django.db.models.fields.TextField')(null=True, blank=True), keep_default=False)

        # Adding field 'Publisher.beacon_throttle'
        db.add_column(u'publishers', 'beacon_throttle', self.gf('django.db.models.fields.FloatField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Network.tag_template'
        db.delete_column(u'networks', 'tag_template')

        # Deleting field 'Publisher.beacon_throttle'
        db.delete_column(u'publishers', 'beacon_throttle')
    ...
    models = {
        ...
        'frontend.network': {
            ...
            'brand_safety_level': ('django.db.models.fields.IntegerField', [], {'default': '5', 'null': 'True', 'blank': 'True'}),
            ...
            'tag_template': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
            'updated_at': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'auto_now_add': 'True', 'blank': 'True'}),
        ...
        'frontend.publisher': {
            ...
            'beacon_throttle': ('django.db.models.fields.FloatField', [], {'null': 'True', 'blank': 'True'}),
            'brand_safety_level': ('django.db.models.fields.IntegerField', [], {'default': '1', 'null': 'True', 'blank': 'True'}),
            'created_at': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
