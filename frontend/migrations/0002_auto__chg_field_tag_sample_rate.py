...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Tag.sample_rate'
        db.alter_column(u'tags', 'sample_rate', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=5, decimal_places=2))


    def backwards(self, orm):
        
        # Changing field 'Tag.sample_rate'
        db.alter_column(u'tags', 'sample_rate', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=7, decimal_places=2))
